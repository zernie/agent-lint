<!-- vigiles:sha256:6547e8b11aef2a8e compiled from examples/CLAUDE.md.spec.ts -->
...
**Enforced by:** `vigiles/test-file-pairing`
**Why:** Every source module should have a corresponding test file.
**Check:** every `src/**/*.ts` has `{name}.test.ts`
