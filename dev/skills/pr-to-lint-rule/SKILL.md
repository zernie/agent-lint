...
The reference gate lives in `compiler/gate.js` (two-stage: self-test + a blind
adversarial gold set), the canonical adversarial cases in `compiler/gold/gold.json`,
