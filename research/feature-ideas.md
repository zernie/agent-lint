...
|                                       | **#13 Sandboxed exec**         | **High** | **moat (2026-06-11): "be good at sandboxing & testing" since the eval-runner space is promptfoo's.** Harness-test tier already confines under bwrap; extend to `runHook` + eval tier + non-Linux (`sandbox-exec`/docker) |
