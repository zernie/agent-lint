...
| `experimental_equivalentDisasters`                                                                                                                                                                       | 2026-09-02 | Days old. Its only user is this repo's own test. The set of rewrite rules and the id format of the generated cases are the parts most likely to change. Details: [the disaster battery](compiled-hooks.md#one-command-many-spellings--experimental_equivalentdisasters).                |
