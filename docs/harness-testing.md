...
- [`docs/harnesses.md`](harnesses.md) — which harness vigiles targets (Claude Code now, Codex likely next) and how you pick one: import `vigiles/claude-code` beside the harness-agnostic `vigiles/testing` core.
