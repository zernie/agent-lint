...
| Skills                      | `untested-skill`, `skill-frontmatter`, `description-overlap`, `frontmatter-valid`, `skill-resource-resolves` | all with skills                           |
...
| Safety (skills + subagents) | `lethal-trifecta`                                                                                            | all (subagent half n/a on Codex)          |
